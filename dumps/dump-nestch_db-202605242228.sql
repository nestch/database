...
--
-- Table structure for table `creditsLedger`
--

DROP TABLE IF EXISTS `creditsLedger`;
...
--
-- Dumping data for table `creditsLedger`
--

LOCK TABLES `creditsLedger` WRITE;
/*!40000 ALTER TABLE `creditsLedger` DISABLE KEYS */;
/*!40000 ALTER TABLE `creditsLedger` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `paymentsTable` (
  ...
  `method` enum('CREDIT_CARD','PIX','BOLETO','PAYPAL') COLLATE utf8mb4_unicode_ci NOT NULL,
...
LOCK TABLES `paymentsTable` WRITE;
...
CREATE TABLE `userActivation` (
  ...
  `activatedByUserID` int DEFAULT NULL,
  ...
  `actionType` enum('ATIVAR','INATIVAR') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `diditSessionId` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `userActivation` VALUES (14,31,NULL,'583735','2026-05-24 18:45:41',NULL,NULL);
...
INSERT INTO `userTable` VALUES (1,1766696279,1766696279,'Owner@email.com','$pbkdf2-sha256$30000$GYMwJqQUgrC2do7RujcmxA$LIf24FM3dkEClrSmO1rbySeGoBnOU.RkHSByAp2CqdA','Owner','(88) 88888-8888','0',0,'1'),(2,1766696279,1766696279,'Agent@email.com','$pbkdf2-sha256$30000$GYMwJqQUgrC2do7RujcmxA$LIf24FM3dkEClrSmO1rbySeGoBnOU.RkHSByAp2CqdA','Agent','(77) 77777-7777','12345',300,'1'),(3,1766696279,1766696279,'Client1@email.com','$pbkdf2-sha256$30000$GYMwJqQUgrC2do7RujcmxA$LIf24FM3dkEClrSmO1rbySeGoBnOU.RkHSByAp2CqdA','Client1','(66) 66666-6666','0',30.01,'1'),(4,1766696279,1766696279,'Client2@email.com','$pbkdf2-sha256$30000$GYMwJqQUgrC2do7RujcmxA$LIf24FM3dkEClrSmO1rbySeGoBnOU.RkHSByAp2CqdA','Client2','(555) 55555-5555','0',0,'1'),(5,1768742722,1768742722,'string','$pbkdf2-sha256$30000$wbgX4rz33nuvdQ6BsJbyvg$Y3NZOOmhkyLlM2T.USabgSlBrdaWAI4sbvt0CeZVEeI','string','string','string',0,'1'),(10,1768766403,1772798928,'frcangussu@gmail.com','$pbkdf2-sha256$30000$TslZ6z3HmBMiJATA2HsvJQ$zF3UgF78VafRmeKr7BxBHD64TO.wcQnPOoYg/KnxqNE','fernando','61991330123',NULL,0,'1'),(31,1779648340,1779648340,'lanacangussu@gmail.com','$pbkdf2-sha256$30000$rvX.P4ewVmpNqdWakxJiDA$.8a6eIQgEyGZ5oKsxGeLRsHBIPhJYE/u1WFOrv3/eDM','lana','61991330123','31772',0,'0');
...
-- Dump completed on 2026-05-24 22:29:02
